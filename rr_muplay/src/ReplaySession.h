...
public:
  ...
  /* Ant Edit */
  void set_muplay_mode(bool muplay_mode) { flags_.muplay_mode = muplay_mode; }
  ...
  /* ANT EDIT */
  ReplayTraceStep get_current_step() { return current_step; };
  void set_current_step(ReplayTraceStep step) { current_step = step; };
  Completion try_this_trace_step(ReplayTask* t, StepConstraints constraints, ReplayTraceStep this_step); 
private:
